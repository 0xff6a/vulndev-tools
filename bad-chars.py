...
def restart_service():
    ...
    subprocess.Popen('ovstop -c ovas').communicate()  # This adds to reliability
    subprocess.Popen('ovstart -c ovas').communicate() # Start the process
...
def check_char(rawdata):
    ...
    if rawdata == "http://" + "A"*8 + cur_char * 92 + "B"*8:
